        ...
        <div className="flex min-h-screen bg-[#F8F9FC]">
            ...
            <div className="ml-64 flex-1 flex flex-col">
                ...
                <header className="h-20 bg-white/80 backdrop-blur-md border-b border-slate-200 px-8 flex items-center justify-between sticky top-0 z-40">
                    <div className="flex items-center gap-4 bg-slate-50 px-4 py-2.5 rounded-xl w-96 max-w-full border border-slate-200 focus-within:border-indigo-300 focus-within:ring-4 focus-within:ring-indigo-50 transition-all">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-3 cursor-pointer group">
                            ...
                            <div className="w-10 h-10 rounded-xl bg-slate-200 overflow-hidden border-2 border-white shadow-sm ring-1 ring-slate-100 transition-transform group-hover:scale-105">
