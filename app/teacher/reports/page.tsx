                                ...
                                <tr>
                                    <td colSpan={4} className="px-8 py-20 text-center">
                                        <div className="flex flex-col items-center gap-3">
                                            ...
                                            <p className="text-sm font-bold text-slate-400 uppercase tracking-widest">Accessing Secure Logs...</p>
                                        </div>
                                    </td>
                                </tr>
                            ) : reports.length === 0 ? (
                                ...
                                <tr key={report.id} className="hover:bg-slate-50/50 transition-colors group">
                                    <td className="px-8 py-5">
                                        <div className="flex items-center gap-4">
                                            <div className="w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center text-slate-400 border border-slate-200 group-hover:border-purple-300 transition-colors overflow-hidden">
                                                <img src={`https://ui-avatars.com/api/?name=${report.studentName}&background=f3f4f6&color=9333ea`} alt="" />
                                            </div>
